...
原文链接：[https://hpc.llnl.gov/tuts/openMP/](https://hpc.llnl.gov/tuts/openMP/)
...
|:---:|:---:|
| ![](/assets/images/shared_mem.gif) | ![](/assets/images/numa.gif) |
...
|:---:|
|![](/assets/images/hybrid_model.gif)|
...
- linux 下编译命令示例：`g++ Test.cpp -o omptest -fopenmp`
...
|:---:|:---:|:---:|
| ![](/assets/images/work_share1.gif) | ![](/assets/images/work_share2.gif) | ![](/assets/images/work_share2.gif) |
...
![](/assets/images/scheduleStatic.png)

    * 动态(DYNAMIC) - 循环迭代分成小块，并在线程之间动态调度；当一个线程完成一个块时，它被动态地分配给另一个块。默认块大小为1。
![](/assets/images/scheduleDynamic.png)
...
![](/assets/images/scheduleGuided.png)
